...
class MaterialTheme {
  ...
  /// Light medium contrast theme data
  ...
  /// Light high contrast theme data
  ...
  /// Dark medium contrast theme data
  ...
  /// Dark high contrast theme data
  ThemeData darkHighContrast() {
    return theme(darkHighContrastScheme());
  }

  /// Creates theme data with given color scheme
...
class ExtendedColor {
  ...
  /// Light high contrast color family
  final ColorFamily lightHighContrast;

  /// Light medium contrast color family
  final ColorFamily lightMediumContrast;

  /// Dark color family
  final ColorFamily dark;

  /// Dark high contrast color family
  final ColorFamily darkHighContrast;

  /// Dark medium contrast color family
